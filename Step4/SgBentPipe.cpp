...
void CSgBentPipe::Render()
{
	m_mesh->Render();
}

void CSgBentPipe::Create()
{
    // 
    ...
    for(int i=0;  i<m_steps1;  i++)
    {
        ...
        for(int j=0;  j<m_steps2;  j++)
        {
            ...
            m_mesh->AddTriangleVertex(a0, a0, a0);
            m_mesh->AddTriangleVertex(a1, a1, a1);
            m_mesh->AddTriangleVertex(b0, b0, b0);

            m_mesh->AddTriangleVertex(a1, a1, a1);
            m_mesh->AddTriangleVertex(b1, b1, b1);
            m_mesh->AddTriangleVertex(b0, b0, b0);
        }
...
void CSgBentPipe::TransformAt(int slice, const CGrTransform &rot)
{
